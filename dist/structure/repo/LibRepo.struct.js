...
export class LibRepoStructure extends BaseMavenRepo {
    ...
    static NEOFORGE_GROUP = 'net.neoforged';
    static NEOFORGE_ARTIFACT = 'neoforge';
    ...
    getLocalNeoForge(version, classifier) {
        return this.getArtifactByComponents(LibRepoStructure.NEOFORGE_GROUP, LibRepoStructure.NEOFORGE_ARTIFACT, version, classifier, 'jar');
    }
}
