...
export class ForgeResolver extends BaseResolver {
    minecraftVersion;
    forgeVersion;
    discardOutput;
    invalidateCache;
    MOJANG_REMOTE_REPOSITORY = 'https://libraries.minecraft.net/';
    REMOTE_REPOSITORY = 'https://files.minecraftforge.net/maven/';
    repoStructure;
    artifactVersion;
    ...
    async getVersionManifestFromJar(jarPath) {
...
//# sourceMappingURL=Forge.resolver.js.map